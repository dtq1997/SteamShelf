...
class AISearchHost(Protocol):
    ...
    def _center_window(self, win: tk.Toplevel) -> None: ...
    def _ask_filter_owned(self, app_ids: list, *, parent: object = ...) -> list | None: ...
...
class CollectionOpsHost(Protocol):
    ...
    def _center_window(self, win: tk.Toplevel) -> None: ...
    def _ask_filter_owned(self, app_ids: list, *, parent: object = ...) -> list | None: ...
    def _get_owned_app_ids_set(self) -> set[int] | None: ...
...
@runtime_checkable
class SharingHost(Protocol):
    """ui_sharing.py — SharingMixin 所需宿主属性"""
    root: tk.Tk
    current_account: _SteamAccount
    _collections_core: _CollectionsCore | None
    _coll_data_cache: dict
    _game_name_cache: dict[str, str]
    def _ensure_collections_core(self) -> bool: ...
    def _save_and_sync(self, data: dict, backup_description: str = ...) -> None: ...
    def _ui_refresh(self) -> None: ...
...
@runtime_checkable
class LibraryExpressionHost(Protocol):
    """ui_library_expression.py — LibraryExpressionMixin 所需宿主属性"""
    root: tk.Tk
    manager: _SteamNotesManager | None
    _collections_core: _CollectionsCore | None
    _cef_bridge: _CEFBridge | None
    _game_name_cache: dict[str, str]
    _coll_tree: ttk.Treeview
    _lib_all_games: list
    _lib_all_games_backup: list | None
    _coll_data_cache: dict
    _coll_filter_states: dict
    _coll_ops_plus: list
    _coll_ops_minus: list
    _coll_filter_var: tk.StringVar
    _type_filter: set
    _ALL_TYPES: list
    def _ensure_collections_core(self) -> bool: ...
    def _save_and_sync(self, data: list, **kw: object) -> None: ...
    def _ui_refresh(self) -> None: ...
    def _center_window(self, win: tk.Toplevel) -> None: ...
    def _lib_schedule_tree_rebuild(self) -> None: ...
    def _lib_load_notes_data(self) -> tuple: ...
    def _lib_read_filter_state(self) -> dict: ...
    def _lib_should_include_game(self, *args: object, **kw: object) -> bool: ...
    def _get_type_name(self, t: int) -> str: ...
    def _get_app_type(self, g: dict) -> int: ...
    def _invalidate_notes_cache(self) -> None: ...
    def _update_all_cached_sources(self, **kw: object) -> None: ...
